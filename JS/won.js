...
let parameter = {
  x: 0.0581020012911556,
  y: 7.553260167850226e-4
};
let d = 0.0813428018076178;
...
let T20 = {
  data: [55, 69, 32, 64, 85, 41, 66, 99, 71, 59, 54, 18], 
  backgroundColor: [],
  borderColor: [],
...
let OneDay = {
  data: [62, 579, 131, 378, 514, 69, 351, 488, 385, 389, 401, 138], 
  backgroundColor: [], 
  borderColor: [],
  fadedBackgroundColor: [],
  fadedBorderColor: [],
...
let Test = {
  data: [2, 394, 14, 377, 160, 0, 105, 140, 167, 92, 177, 12],
  backgroundColor: [], 
  borderColor: [],
  fadedBackgroundColor: [],
  fadedBorderColor: [],
